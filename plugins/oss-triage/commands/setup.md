---
description: First run in a workspace — write .oss-triage/config.md, read the repo's governance files, snapshot labels, create the work directory skeleton
